...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    JLabel lblNewLabel_4 = new JLabel("- Edición de Reservas y Huéspedes existentes");
	    lblNewLabel_4.setFont(new Font("Roboto", Font.PLAIN, 17));
	    lblNewLabel_4.setBounds(312, 482, 355, 27);
	    contentPane.add(lblNewLabel_4);
	    
	    JLabel lblNewLabel_5 = new JLabel("- Eliminar todo tipo de registros");
	    lblNewLabel_5.setFont(new Font("Roboto", Font.PLAIN, 17));
	    lblNewLabel_5.setBounds(312, 520, 295, 27);
