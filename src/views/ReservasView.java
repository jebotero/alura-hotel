...
public class ReservasView extends JFrame {
	...
	public static JComboBox<Format> txtForma_pago;
	int xMouse, yMouse;
	...
	public ReservasView() {
		...
		txtForma_pago = new JComboBox();
		txtForma_pago.setBounds(68, 417, 289, 38);
		txtForma_pago.setBackground(SystemColor.text);
		txtForma_pago.setBorder(new LineBorder(new Color(255, 255, 255), 1, true));
		txtForma_pago.setFont(new Font("Roboto", Font.PLAIN, 16));
		txtForma_pago.setModel(new DefaultComboBoxModel(new String[] {"Tarjeta de Crédito", "Tarjeta de Débito", "Dinero en efectivo"}));
		panel.add(txtForma_pago);
	    ...
	    public void guardarReserva() {
	    	try {
				...
				Reserva reserva = new Reserva(java.sql.Date.valueOf(FechaEntrada), java.sql.Date.valueOf(FechaSalida), ReservasView.txtValor.getText(), ReservasView.txtForma_pago.getSelectedItem().toString());
